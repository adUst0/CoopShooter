...
ASCharacter::ASCharacter()
{
	...
	ACharacter::GetCharacterMovement()->MaxWalkSpeed = WalkSpeed;
...
void ASCharacter::SpawnDefaultWeapon()
{
	...
	CurrentWeapon = GetWorld()->SpawnActor<ASWeapon>(StartingWeaponClass, FVector::ZeroVector, FRotator::ZeroRotator, SpawnParameters);
	if (CurrentWeapon)
	{
...
void ASCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Run", IE_Released, this, &ASCharacter::StopRun);
...
void ASCharacter::OnHealthChanged(float Health, float HealthDelta,
